...
<body>
	...
	<form method="POST" action="#">
		<table border=0 align="center">
			<tr>
				<td><label>Enter Activity Title :</label></td>
				<td><input type="text" class="form-control" name="title" placeholder="Subject Title"></td>
			</tr>
			<tr>
				<td><label>Enter # of Questions :</label></td>
				<td><textarea rows="10" cols="50" class="form-control" 
			placeholder="Total Questions" id="message" name="Tques" required
			...
			<tr>
				<td><label>Enter Questions type :</label></td>
				<td><textarea rows="10" cols="50" class="form-control" 
			placeholder="Questions type" id="message" name="Qtype" required
			data-validation-required-message="Please enter your message" minlength="5" 
			data-validation-minlength-message="Min 5 characters" 
	...
	<?php
		if(isset($_POST['submit']))
		{
			...
			if($result)
			{
				echo "<div class='alert alert-success' role='alert'>Successfull Uploaded Activity</div>";
			}
			else
			{
