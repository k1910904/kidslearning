...
<body>
	...
	<form method="POST" action="">
		<table border=0 align="center">
			...
			placeholder="Feedback" name="message" required
			data-validation-required-message="Please enter your Feedback" minlength="5" 
	...
	if(!empty($_POST['id'])&&!empty($_POST['message']))
	{
		if(isset($_POST['btnsubmit']))
		{
			...
			if($result)
			{
				echo "<div class='alert alert-success' role='alert'>Suggestion has sent to Teacher</div>";
